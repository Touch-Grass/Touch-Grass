...
const UserMenu: React.FC<UserMenuProps> = ({isUserMenuVisible, onSavedTrailsClicked, onMyTrailsClicked, onAddTrailClicked, onEditAccountClicked, onLogOutClicked}) => {
    return (
        isUserMenuVisible?
        <div className='user-menu-container'>
            <p id='menu-trails-text'><b><i>Trails</i></b></p>
            <div id='menu-item-saved-trails' className='menu-item' onClick={onSavedTrailsClicked}><Link href='/saved-trail-list'><i>Saved Trails</i></Link></div>
